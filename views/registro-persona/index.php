...
<head>
    ...
    <script src="https://www.google.com/recaptcha/api.js?render=6LeVZncdAAAAAApES_kTUWAIy8Kgc9wn0OKhed03"></script>
</head>
<style>
.fondo2 {
                        ...
                        <div class="card-body">
                            <form action="<?php echo constant('URL'); ?>registroPersona/nuevaPersona" method="POST">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="inputApellido">Apellidos <strong
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="inputContraseña">Contraseña <strong
                                                style="color:red">*</strong></label>
                                ...
                                <div class="form-group text-center ">
                                    <input type="submit" value="Registrarse"
                                        class="btn btn-primary btn-lg float-center btnregistro">
                                </div>
                            </form>
                        </div>
                    </div>
