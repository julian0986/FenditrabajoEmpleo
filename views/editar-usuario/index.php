    ...
    <div class="container pd">
        <div class="row">
            <div class="col-md-10">
                ...
                <br />
                <form action="<?php echo constant('URL') . 'editarUsuario/agregarHojaVida/' . $this->hoja->id; ?>"
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4 align-self-center">
                                    <div class="form-group col-md-12 text-center">
                                        <img class="rounded-circle"
                                            src="<?php echo constant('URL') . $this->hoja->foto; ?>" alt="" width="70%">
                                    </div>
                                </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-7">
                                            <input type="number" value="<?php echo $this->hoja->telefono; ?>"
                                                ...
                                                pattern="[a-zA-Záéíóúüñ0-9_-,.\$%# ]{3,15}" required
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" value="<?php echo $this->hoja->direccion; ?>" name="direccion"
                                        ...
                                        pattern="[a-zA-Záéíóúüñ0-9.#-° ]{3,100}" required
                                ...
                                <div class="form-group col-md-8 ">
                                    ...
                                    <input type="file" name="docHoja" class="form-control-file"
                                        accept=".pdf,.doc,.docx">
                                </div>
                                <div class="form-group text-center col-md-4 ">
                                    <a href="<?php echo $this->hoja->urlHoja; ?>" class="btn btn-primary" role="button"
                                        aria-pressed="true">Descargar HV</a>
                                </div>
                            </div>
                        </div>
                    </div>
