                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 align-self-center">
                                    <button class="btn btn-sm btn-primary collapsed" type="button"
                                        data-toggle="collapse" data-target="#collapseOferta<?php echo $oferta->id; ?>"
                                        aria-expanded="false" aria-controls="collapseOfertaUno">
                                        VER OFERTA
                                    </button>
                                    <a href=<?php echo constant('URL') . 'aplicacionOferta/eliminarOferta/' . $oferta->id ?>
                                        class="btn btn-sm btn-danger" onclick="return confirmar()">ELIMINAR</a>

                                </div>
                            </div>
                        </div>
                        <div id="collapseOferta<?php echo $oferta->id; ?>" class="collapse" aria-labelledby="ofertaUno"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-9">
                                        ...
                                        <p><strong>Fecha de publicación: </strong><?php echo $oferta->fechaInicial; ?>
                                        </p>
