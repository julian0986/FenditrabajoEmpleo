    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #004C92;">
      ...
      <div class="collapse navbar-collapse text-center justify-content-center" id="navbarSupportedContent">
        <ul class="nav navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link link-m" href="<?php echo constant('URL'); ?>hojaVidaUsuario" style="color: white;">
              <ion-icon name="reader-sharp"></ion-icon> HOJA DE VIDA
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link link-m" href="<?php echo constant('URL'); ?>aplicacionOferta" style="color: white;">
              <ion-icon name="file-tray-full-sharp"></ion-icon> APLICACIONES
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link link-m" href="<?php echo constant('URL'); ?>loginPersona/cerrarSesion" style="color: white;">
