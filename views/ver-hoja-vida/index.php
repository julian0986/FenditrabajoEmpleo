                        ...
                        <div class="card" style="border-radius: 0%">
                            ...
                            <div class="card-body row pd-m">
                                <div class="col-md-4 text-center">
                                    <img class="rounded-circle" src="<?php echo constant('URL') . $this->hoja->foto; ?>"
                                        width="40%">
                                </div>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" value="<?php echo $this->hoja->apellido; ?>" name="apellido"
                                        class="form-control" id="inputApellidos" readonly>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="inputNIdentificacion">Estado civil</label>
                                    <input type="text" name="numeroId" value="<?php echo $this->hoja->estado; ?>"
                                        class="form-control" id="inputNIdentificacion" readonly>
                                </div>
                                <div class="form-group col-md-4">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="number" name="numeroId" value="<?php echo $this->hoja->telefono; ?>"
                                        class="form-control" id="inputTelefono" readonly>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="estaticoDepartamento">Departamento</label>
                                    <input type="text" name="numeroId" value="<?php echo $this->hoja->departamento; ?>"
                                        class="form-control" id="estaticoDepartamento" readonly>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="estaticoDireccion">Dirección</label>
                                    <input type="text" name="numeroId" value="<?php echo $this->hoja->direccion; ?>"
                                        class="form-control" id="estaticoDireccion" readonly>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="estaticoNacionalidad">Nacionalidad</label>
                                    <input type="text" name="numeroId" value="<?php echo $this->hoja->nacionalidad; ?>"
                                        class="form-control" id="estaticoNacionalidad" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="card" style="border-radius: 0%">
                            ...
                            <div class="card-body row pd-m">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="numeroId" value="<?php echo $this->hoja->titulo; ?>"
                                        class="form-control" id="estaticoCargoTitulo" readonly>
                                </div>
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="perfil" id="inputPerfil" class="form-control" rows="6"
                                        readonly><?php echo $this->hoja->perfil; ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="card" style="border-radius: 0%">
