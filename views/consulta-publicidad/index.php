...
<head>
    ...
    <title>Cosulta publicidad - Fendipetroleo Nacional</title>
    ...
    <div>
        <div class="container pd">
            ...
            <table class="table table-bordered" style="margin-top:2%">
                <thead>
                    <tr>
                        <th style="width:60%" scope="col">Nombre de la publicidad</th>
                        <th style="width:40%" scope="col">Opciones</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td>Precios bajos en cursos</td>
                        <td class="text-center">
                            <a class="btn btn-info" href="<?php echo constant('URL'); ?>verPublicidad">
                                <ion-icon style="font-size:20px" name="eye"></ion-icon>
                            </a>
                        </td>
                    </tr>
                    <tr>
                        <td>Descuentos en clases</td>
                        <td class="text-center">
