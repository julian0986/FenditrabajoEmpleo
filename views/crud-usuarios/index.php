...
<head>
    ...
    <title>Usuarios - Fendipetroleo Nacional</title>
    ...
    <div>
        <div class="container pd">
            <div class="col-md-12 text-center">
                <form action="<?php echo constant('URL'); ?>crudUsuarios/buscar" method="POST">
                    <div class="row">
                        <div class="col-md-8">
            ...
            <table class="table table-bordered" style="margin-top:2%">
                ...
                <tbody>
                    <?php
                    include_once 'models/entity/persona.php';
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a class="btn btn-sm btn-primary" href="<?php echo constant('URL') . 'editarUsuario/detalles/' . $usuario->id; ?>">
                                    <ion-icon style="font-size:20px" name="build-outline"></ion-icon>
                                </a>
                                <a class="btn btn-sm btn-danger" href="<?php echo constant('URL') . 'crudUsuarios/eliminarUsuario/' . $usuario->id; ?>" onclick="return confirmar()">
                ...
                <ul class="pagination justify-content-center">
                    <?php if ($this->numPaginas != "0") { ?>
                        <li class="page-item <?php echo  $_SESSION['pagina'] <= 1 ? 'disabled' : '' ?>">
                            <a class="page-link" href="<?php echo constant('URL'); ?>crudUsuarios/nuevaPagina/<?php echo $_SESSION['pagina'] - 1; ?>">Anterior</a>
                        </li>
                        <?php for ($i = 0; $i < $this->numPaginas; $i++) { ?>
                            <li class="page-item <?php echo $_SESSION['pagina'] == $i + 1 ? 'active' : '' ?>">
                                <a class="page-link" href="<?php echo constant('URL'); ?>crudUsuarios/nuevaPagina/<?php echo $i + 1; ?>"><?php echo $i + 1; ?></a>
                            </li>
                        <?php } ?>
                        <li class="page-item <?php echo  $_SESSION['pagina'] >= $this->numPaginas ? 'disabled' : '' ?>">
                            <a class="page-link" href="<?php echo constant('URL'); ?>crudUsuarios/nuevaPagina/<?php echo $_SESSION['pagina'] + 1; ?>">Siguiente</a>
                        </li>
                    <?php } ?>
                </ul>
            </nav>
