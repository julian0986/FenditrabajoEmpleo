...
<head>
    ...
    <title>Editar publicidad - Fendipetroleo Nacional</title>
...
<body>
    ...
    <div class="container pd">
        <div class="row">
            <div class="col-md-6">
                <h1 class="text-center">Editar Publicidad</h1>
            </div>
            <div class="col-md-6 text-center">
                <a href="<?php echo constant('URL'); ?>crudPublicidad" class="btn btn-secondary text-center">Volver</a>
            </div>
        </div>
        <form action="<?php echo constant('URL'); ?>editarPublicidad/editar" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="col-md-8">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="lema" id="inputLema" class="form-control" rows="3" pattern="[a-zA-Záéíóúüñ0-9_-,.\$% ]{3,500}" required title="Solo se aceptan letras y numeros"><?php echo $this->publicidad->lema; ?></textarea>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <br />
                            <div class="col-md-12">
                                <img class="align-self-center" src="<?php echo constant('URL') . $this->publicidad->imagen ?>" width="100%">
                            </div>
