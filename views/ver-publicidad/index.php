...
<body>
    ...
    <div class="container pd">
        <div class="row">
            <div class="col-md-6">
                <h1 class="text-center">Ver Publicidad</h1>
            </div>
                ...
                <div class="form-row">
                    <div class="col-md-8">
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" value="<?php echo $this->publicidad->nombre; ?>" name="nombre" class="form-control" id="inputNombre" readonly>
                        </div>
                        <div class="form-group col-md-12">
                            <label for="inputNombre">Url de la publicidad</label>
                            <input type="text" value="<?php echo $this->publicidad->link; ?>" name="nombre" class="form-control" id="inputNombre" readonly>
                        </div>
                        <div class="form-group col-md-12">
                            <label for="inputPerfil">Lema de la publicidad</label>
                            <textarea name="perfil" id="inputPerfil" class="form-control" rows="6" readonly><?php echo $this->publicidad->lema; ?></textarea>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <img class="align-self-center" src="<?php echo constant('URL') . $this->publicidad->imagen ?>" width="70%">
                    </div>
                </div>
            </div>
        </div>
