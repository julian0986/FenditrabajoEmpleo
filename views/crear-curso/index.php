...
<head>
    ...
    <title>Crear curso - Fendipetroleo Nacional</title>
...
<body>
    ...
    <div class="container pd">
        ...
        <form action="<?php echo constant('URL'); ?>crearCurso/agregar" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" value="" name="nombre" class="form-control" id="inputNombre" pattern="[a-zA-Záéíóúüñ0-9_-,.\$% ]{3,50}" required title="Solo se aceptan letras">
                        </div>
                        <div class="form-group col-md-12">
                            <label for="inputDescripcion">Descripción</label>
                            <textarea name="descripcion" id="inputDescripcion" class="form-control" rows="3" pattern="[a-zA-Záéíóúüñ0-9_-,.\$% ]{5,500}" required title="Solo se aceptan letras y numeros"></textarea>
                        </div>
                        <div class="form-group col-md-12">
                            <label for="inputEnlace">Enlace o Link</label>
                            <input type="text" value="" name="link" class="form-control" id="inputEnlace" required>
                        </div>
                        <div class="form-group col-md-12">
                            <label for="inputEntidad">Instituto educativo</label>
                            <input type="text" value="" name="entidad" class="form-control" id="inputEntidad" pattern="[a-zA-Záéíóúüñ0-9_-,.\$% ]{3,100}" required title="Solo se aceptan letras">
                        </div>
                        <div class="form-group col-md-12">
