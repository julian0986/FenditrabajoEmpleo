...
<body>
        ...
        <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner" style="height: 400px;position: relative;">
                ...
                <div class="container pd" style="padding-top: 8%">
                    <div class="card"
                        style="width: 100%; border-color: rgba(128,128,128,1); background-color: rgba(255,255,255,0.8);">
                        <div class="card-body d-flex justify-content-center"
                            style="background-color: rgba(255,255,255,0.1); padding: 0%; margin:0%;">
                            <form action="<?php echo constant('URL'); ?>resultadosGeneral/buscar" method="POST">
                                <div class="form-row" style="padding-left:2%; padding-right:2%">
                                    <div class="form-group col-md-12" style="margin:0%; padding-top:1%">
                                        <h5 class="card-title text-center mb-2">Comienza la busqueda de oportunidades de
                                            empleo</h5>
                                    </div>
                                    <div class="form-gruop col-md-5">
                                        <div class="input-group mb-3">
                                            ...
                                            <input name="nombre" type="text" class="form-control"
                                                id="inlineFormInputName2" placeholder="Palabra clave">
                                        </div>
                                        <p style="font-size: 15px"> Trabaje como administrador, jefe de patio, promotor
                                            de ventas.</p>
                                    </div>
                                    <div class="form-gruop col-md-4">
                                        <div class="input-group mb-3">
                                            ...
                                            <select name="departamento" class="form-control" id="departamento">
                                                ...
                                                <option value="SanAndres">Archipiélago de San Andrés, Providencia y
                    ...
                    <div class="carousel-item active" style="padding-left:2%; padding-right: 2%">
                        <div class="card-deck">
                            <?php
                                ...
                                ?>
                            <div class="card" style="border-color: transparent">
                                <a href="<?php echo $publi->link; ?>" target="_blank"><img style="border-radius: 10px;"
                                        width="50%" src="<?php echo constant('URL') . $publi->imagen; ?>"></a>
                            </div>
                            <?php } ?>
                        </div>
                    </div>
 ...
 -->
    ...
    <!--Start Cookie Script-->
    <script type="text/javascript" charset="UTF-8" src="//cdn.cookie-script.com/s/3f64d4be21d20eb44e654b17532f4cab.js">
    </script>
    <!--End Cookie Script-->
</body>
