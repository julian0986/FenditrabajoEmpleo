    ...
    <div class="pd-m">
        <div class="row">
            <div class="col-md-8">
                ...
                <form action="<?php echo constant('URL'); ?>perfilEmpresa/editarPerfil" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                <div class="form-row col-md-8">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" value="<?php echo $this->empresa->nit; ?>" name="nit" class="form-control" id="inputNIT" pattern="[0-9.- ]{8,50}" title="Solo se aceptan numeros">
                                    </div>
                                    <div class="form-group col-md-12">
                                    ...
                                    <div class="form-group col-md-7">
                                        ...
                                        <input type="text" name="ciudad" value="<?php echo $this->empresa->ciudad; ?>" class="form-control" id="inputCiudadEmpresa" pattern="[a-zA-Záéíóúüñ0-9_-,.\$% ]{3,48}" required title="Solo se aceptan letras">
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="descripcion" id="inputDescripcionEmpresa" class="form-control" rows="10" pattern="[a-zA-Záéíóúüñ0-9_-,.\$% ]{10,500}" required title="Solo se aceptan letras y numeros"><?php echo $this->empresa->descripcion; ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
