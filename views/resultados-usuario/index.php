                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-3 text-center">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <a class="btn btn-sm btn-primary" href="<?php echo constant('URL') . 'resultadosUsuario/reiniciar' ?>">
                    ...
                    <div class="card" style="border-color: #224b8b; border-radius:0%">
                        ...
                        <div class="card-body text-center">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <a href=<?php echo constant('URL') . 'detalleOfertaUser/detalle/' . $oferta->id ?> class="btn btn-primary" style="font-size: 15px">
                    ...
                    <ul class="pagination justify-content-center">
                        <?php if ($this->numPaginas != "0") { ?>
                            ...
                            <li class="page-item <?php echo  $_SESSION['pagina'] <= 1 ? 'disabled' : '' ?>">
                                <a class="page-link" href="<?php echo constant('URL'); ?>resultadosUsuario/nuevaPagina/<?php echo $_SESSION['pagina'] - 1; ?>">Anterior</a>
                            </li>
                            <?php for ($i = 0; $i < $this->numPaginas; $i++) { ?>
                                <li class="page-item <?php echo $_SESSION['pagina'] == $i + 1 ? 'active' : '' ?>">
                                    <a class="page-link" href="<?php echo constant('URL'); ?>resultadosUsuario/nuevaPagina/<?php echo $i + 1; ?>"><?php echo $i + 1; ?></a>
                                </li>
                            <?php } ?>
                            <li class="page-item <?php echo  $_SESSION['pagina'] >= $this->numPaginas ? 'disabled' : '' ?>">
                                <a class="page-link" href="<?php echo constant('URL'); ?>resultadosUsuario/nuevaPagina/<?php echo $_SESSION['pagina'] + 1; ?>">Siguiente</a>
                            </li>
                        <?php } ?>
                    </ul>
                </nav>
