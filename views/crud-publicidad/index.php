...
<head>
    ...
    <title>Publicidad - Fendipetroleo Nacional</title>
    ...
    <div>
        <div class="container pd">
            <div class="col-md-12 text-center">
                <form action="<?php echo constant('URL'); ?>crudPublicidad/buscar" method="POST">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-2">
                            <a href="<?php echo constant('URL'); ?>crearPublicidad" class="btn btn-success">Crear Publicidad</a>
                        </div>
                        <div class="col-md-2">
            ...
            <table class="table table-bordered" style="margin-top:2%">
                <thead>
                    <tr>
                        <th style="width:40%" scope="col">Nombre de la empresa</th>
                        <th style="width:40%" scope="col">Lema</th>
                ...
                <tbody>
                    ...
                    foreach ($this->publicidad as $row) {
                        $publi = new Publicidad();
                        $publi = $row;
                    ?>
                        <tr>
                            <td><?php echo $publi->nombre; ?></td>
                            <td><?php echo $publi->lema; ?></td>
                            <td class="text-center">
                                <a class="btn btn-sm btn-info" href="<?php echo constant('URL') . 'verPublicidad/detalles/' . $publi->id; ?>">
                                    <ion-icon style="font-size:20px" name="eye"></ion-icon>
                                </a>
                                <a class="btn btn-sm btn-primary" href="<?php echo constant('URL') . 'editarPublicidad/detalles/' . $publi->id; ?>">
                                    <ion-icon style="font-size:20px" name="build-outline"></ion-icon>
                                </a>
                                <a class="btn btn-sm btn-danger" href="<?php echo constant('URL') . 'crudPublicidad/eliminarPublicidad/' . $publi->id; ?>">
                ...
                <ul class="pagination justify-content-center">
                    <?php if ($this->numPaginas != "0") { ?>
                        <li class="page-item <?php echo  $_SESSION['pagina'] <= 1 ? 'disabled' : '' ?>">
                            <a class="page-link" href="<?php echo constant('URL'); ?>crudPublicidad/nuevaPagina/<?php echo $_SESSION['pagina'] - 1; ?>">Anterior</a>
                        </li>
                        <?php for ($i = 0; $i < $this->numPaginas; $i++) { ?>
                            <li class="page-item <?php echo $_SESSION['pagina'] == $i + 1 ? 'active' : '' ?>">
                                <a class="page-link" href="<?php echo constant('URL'); ?>crudPublicidad/nuevaPagina/<?php echo $i + 1; ?>"><?php echo $i + 1; ?></a>
                            </li>
                        <?php } ?>
                        <li class="page-item <?php echo  $_SESSION['pagina'] >= $this->numPaginas ? 'disabled' : '' ?>">
                            <a class="page-link" href="<?php echo constant('URL'); ?>crudPublicidad/nuevaPagina/<?php echo $_SESSION['pagina'] + 1; ?>">Siguiente</a>
                        </li>
                    <?php } ?>
                </ul>
            </nav>
