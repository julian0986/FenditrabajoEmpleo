        ...
        <div class="col-md-6 col-md-offset-3">
          <div class="card shadow-lg p-3 mb-5 bg-white rounded">
            ...
            <div class="card-body text-center">
              ...
              <br />
              <a style="color: #0069d9;" href="<?php echo constant('URL'); ?>recuperarEmpresa">¿Olvidó su
                contraseña?</a>
            </div>
            <div class="card-footer text-center logemp">
              <p>Aun no tienes cuenta, registrate <a href="<?php echo constant('URL'); ?>registroEmpresa"
