...
<head>
    ...
    <title>Editar curso - Fendipetroleo Nacional</title>
...
<body>
    ...
    <div class="container pd">
        ...
        <form action="<?php echo constant('URL'); ?>editarCurso/editar" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="col-md-8">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" value="<?php echo $this->curso->nombre; ?>" name="nombre" class="form-control" id="inputNombre" pattern="[a-zA-Záéíóúüñ0-9_-,.\$% ]{3,100}" required title="Solo se aceptan letras">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="inputDescripcion">Descripción</label>
                                <textarea name="descripcion" id="inputDescripcion" class="form-control" rows="6" pattern="[a-zA-Záéíóúüñ0-9_-,.\$% ]{5,500}" required title="Solo se aceptan letras y numeros"><?php echo $this->curso->descripcion; ?></textarea>
                            </div>
                            <div class="form-group col-md-12">
                                <label for="inputEnlace">Enlace o Link</label>
                                <input type="text" value="<?php echo $this->curso->link; ?>" name="link" class="form-control" id="inputEnlace" required>
                            </div>
                            <div class="form-group col-md-12">
                                <label for="inputEntidad">Instituto educativo</label>
                                <input type="text" value="<?php echo $this->curso->entidad; ?>" name="entidad" class="form-control" id="inputEntidad" pattern="[a-zA-Záéíóúüñ0-9_-,.\$% ]{3,100}" required title="Solo se aceptan letras">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="col-md-12">
